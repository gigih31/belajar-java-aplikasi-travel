...
public class ItemDomain implements Serializable {
    ...
    private String getTourGuidePhone;
    ...
    public String getGetTourGuidePhone() {
        return getTourGuidePhone;
    }

    public void setGetTourGuidePhone(String getTourGuidePhone) {
        this.getTourGuidePhone = getTourGuidePhone;
    }
